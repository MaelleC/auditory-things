...
{	
    ...
    sptime  = (double*)mxCalloc((long) ceil(totalstim*nrep),sizeof(double));  	
...
//     FILE *fp;
//     fp = fopen( "catmodel_ctmp_sptime_noref", "w" );
// 	for(i = 0; i < nspikes; i++)
// 	{        
// 		fprintf( fp, "%f", sptime[i] );
// 		fprintf( fp, "  ");
// 	};
// 	fprintf(fp, "\n");
// 	fclose(fp);
...
{  
	...
	c1      = 0.0;
	s1      = 0.0125;
    dead    = tdres;  /* edit MD, original value 0.00075 */
